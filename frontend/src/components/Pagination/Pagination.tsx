  ...
  return (
    ...
    page <= +totalPages && (
      <div id="pagination" className="flex gap-2 mt-3 pb-2 items-center justify-end">
        {/* Previous Button */}
        <Button
          className={`flex items-center text-black! hover:bg-gray-300! justify-center p-0! w-10 h-10 ${
        ...
        {pages.map((pageNumber) => (
          <Button
            ...
            className={`flex items-center justify-center p-0! w-10 h-10 border rounded-md ${
              pageNumber === page
                ? "text-black! bg-indigo-600 hover:bg-indigo-600! border-indigo-600"
                : "text-gray-700 text-black! bg-white border-gray-300 hover:bg-gray-300!"
            }`}
        ...
        {/* Next Button */}
        <Button
          className={`flex text-black! items-center justify-center hover:bg-gray-300! w-10 h-10 ${
